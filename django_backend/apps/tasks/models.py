...
from apps.common.managers import BaseModelManager
from apps.common.models import BaseModel
from apps.tasks.choices import TaskPriority, TaskStatus
from apps.tasks.managers import ActiveTaskManager, TaskManager
...
class TaskTemplate(BaseModel):
    ...
    default_estimated_hours = models.DecimalField(
        max_digits=8,
        decimal_places=2,
        validators=[MinValueValidator(0.1), validate_estimated_hours],
        null=True,
        blank=True,
...
class Task(BaseModel):
    ...
    completion_percentage = models.IntegerField(
        default=0,
        validators=[MinValueValidator(0), MaxValueValidator(100), validate_completion_percentage],
